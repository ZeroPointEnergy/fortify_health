...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Fortify Health web application."
  #
  #
  ...
  #
  # settings.secret_key_base= carkJ0BlhpUj83B92yDzy7f58O9zhc9hO8voqAB5R7o
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("fortify_health.log", "w"))
  #
  #
end
